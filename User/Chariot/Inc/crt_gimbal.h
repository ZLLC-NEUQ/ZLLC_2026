...
float Class_Gimbal_Yaw_Motor_LK7025::Get_True_Rad_Yaw()
{
    return (True_Rad_Yaw);
}
...
protected:
    ...
    // pitch轴最小值
    float Min_Pitch_Angle = -35.0f;
    // pitch轴最大值
    float Max_Pitch_Angle = 17.0f ;
    // 大pitch轴最小值
    float Min_Pitch_2_Angle = LOCK_PITCH;
    // 大pitch轴最大值
    float Max_Pitch_2_Angle = LOCK_PITCH + 1.45f; //均待定
    // 电磁铁固定角度
